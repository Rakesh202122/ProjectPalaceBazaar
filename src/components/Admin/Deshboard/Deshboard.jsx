  ...
  return (
    <Grid 
        ...
        templateColumns={['1fr', '5fr 1fr']} >
            {
                loading || !stats ? (<Loader color='purple.500' />) : (<Box boxSizing='border-box' py='16' px={['4', '0']}>
                <Text textAlign={'center'} opacity={0.5} children={`Last Change on ${String(new Date(stats[11].createdAt)).split('G')[0]}`} />
