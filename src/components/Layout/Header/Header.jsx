...
import { RiDatabaseFill, RiLogoutBoxLine, RiMenu5Fill } from 'react-icons/ri'
...
const Header = ({isAuthenticated = false, user}) => {
  ...
  <Drawer placement='left' onClose={onClose} isOpen={isOpen}>
    <DrawerOverlay />
    <DrawerContent>
        <DrawerHeader borderBottomWidth={'1px'}>Project Palace Bazaar</DrawerHeader>

        <DrawerBody>
            <VStack spacing={'4'} alignItems="flex-start">
                <LinkButton onClose={onClose} url='/' title="Home" />
                <LinkButton onClose={onClose} url='/courses' title="Browse All Courses" />
                {/* <LinkButton onClose={onClose} url='/notes' title="Download Notes Free" /> */}
